...
export const editingInstructions =
  "For photographic editing, read get_editing_guide first. Inspect get_preview and analyze_photo for each image; use suggest_adjustments(referenceId) for adaptive reference matching rather than copying recipes. Review composition explicitly. RAW previews are developed 8-bit sRGB, not sensor data. Follow current revisions and visually verify edits.";
